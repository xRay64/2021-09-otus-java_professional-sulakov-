...
class SensorDataProcessorBufferedTest {
    ...
    void shouldExecFlushWhenBufferOverFlow() {
        ...
        Assertions.assertThat(flushedData).hasSize(BUFFER_SIZE);
    }
    ...
    void shouldFlushBufferDataSortedByTime() {
        ...
        Assertions.assertThat(flushedData).containsExactlyElementsOf(originalSensorDataList);
    }
    ...
    void shouldFlushTheRestOfTheBufferDataWhenOnProcessingEndFired() {
        ...
        Assertions.assertThat(flushedData).hasSize(BUFFER_SIZE / 2);
    }
    ...
    void shouldCorrectFlushDataAndWriteThreads() throws InterruptedException {
        ...
        Assertions.assertThat(writer.getData()).hasSize(sensorDataList.size());
        Assertions.assertThat(writer.getData()).isEqualTo(sensorDataList);
    }
